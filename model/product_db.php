...
function add_products(string $code, string $name, int $version, string $release_date) 
{
    global $db;
...
function update_product(string $code, string $name, int $version, string $release_date) 
{
    global $db;
